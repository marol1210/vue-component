...
Vue.component('side-bar', require('@/pages/base/SideBar.vue').default)
Vue.component('c-menu', require('@/pages/base/Menu.vue').default)
Vue.component('c-header', require('@/pages/base/Header.vue').default)
