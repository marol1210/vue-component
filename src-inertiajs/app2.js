...
let data_set = '{"component":"base/Table","props":{"event":{"id":80,"title":"Birthday party","start_date":"2019-06-02","description":"Come out and celebrate Jonathan&apos;s 36th birthday party!"}},"url":"/","version":"c32b8e4965f418ad16eaebba1d4e960f"}';
new Vue({
  i18n,
  render: h => h(App, {
    props: {
